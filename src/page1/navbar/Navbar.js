  ...
  return (
    <div className='header'>
      ...
      <div className={`dropdown_menu ${isMenuOpen ? 'open' : ''}`}>
        <ul>
          <li><Link to='/atlasswings/'>Home</Link></li>
          <li><Link to='/atlasswings/booking'>Offres</Link></li>
          <li><Link to='/atlasswings/About'>About Us</Link></li>
          <li><Link to='/atlasswings/services'>Services</Link></li>
          <li><a href="">Sign In</a></li>
          <li><a href="">Sign Up</a></li>
          <li><a href="#get-started" className="action_btn">Get Started</a></li>
        </ul>
